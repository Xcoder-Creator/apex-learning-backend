...
const edit_a_class = async (req, res) => {
    ...
    if (environment === 'development'){
        ...
        if (req.body){
            ...
            if (form_data.access_token && form_data.class_code && form_data.class_name && form_data.class_section && form_data.class_subject && form_data.class_room){
                                                                        ...
                                                                        if (result.status === false){
                                                                            ...
                                                                            if (result.data.length > 0 && result.data.length === 1){
                                                                                ...
                                                                                if (result.status === false){
                                                                                    ...
                                                                                    if (result.data.length > 0 && result.data.length === 1){
                                                                                        let result = await db_query.check_if_teacher_of_class_and_active(user_id, class_code);
                                                                                        ...
                                                                                        if (result.status === false){
                                                                                            ...
                                                                                            if (result.data.length > 0 && result.data.length === 1){
                                                                                                let result = await db_query.edit_class_details(class_code, class_name, class_subject, class_room, class_section);
                                                                                                ...
                                                                                                if (result.status === false){
                                                                                                    ...
                                                                                                    res.json({ status: 'class_details_updated_successfully', class_details: { class_name: class_name, class_section: class_section, class_subject: class_subject, class_room: class_room }, token_info: 'token_available', new_accessToken: new_access_token });
                                                                                                }
                                                                                            } else {
                                                                                                res.statusCode = 401;
                                                                            ...
                                                                            if (result.status === false){
                                                                                ...
                                                                                if (result.data.length > 0 && result.data.length === 1){
                                                                                    ...
                                                                                    if (result.status === false){
                                                                                        ...
                                                                                        if (result.data.length > 0 && result.data.length === 1){
                                                                                            let result = await db_query.check_if_teacher_of_class_and_active(user_auth_id, class_code);
                                                                                            ...
                                                                                            if (result.status === false){
                                                                                                ...
                                                                                                if (result.data.length > 0 && result.data.length === 1){
                                                                                                    ...
                                                                                                    if (result.status === false){
                                                                                                        ...
                                                                                                        res.statusCode = 200;
                                                                                                        res.json({ status: 'class_details_updated_successfully', token_info: 'no_token' });
                                                                                                    }
                                                                                                } else {
                                                                                                    res.statusCode = 401;
                                                                                                    res.json({ status: 'not_allowed' });
        ...
        if (req.body){
            ...
            //Check if the appropriate request parameters are set
            if (form_data.class_code && form_data.class_name && form_data.class_section && form_data.class_subject && form_data.class_room){
                //Filter and sanitize the request parameters
                let class_code = sanitize_data(form_data.class_code);
                let class_name = sanitize_data(form_data.class_name);
                let class_section = sanitize_data(form_data.class_section);
                                                                                            ...
                                                                                            if (result.status === false){
                                                                                                ...
                                                                                                if (result.data.length > 0 && result.data.length === 1){
                                                                                                    ...
                                                                                                    if (result.status === false){
                                                                                                        ...
                                                                                                        res.statusCode = 200;
                                                                                                        let new_access_token = generate_access_token(user_id, 'user_direct_access_token');
                                                                                                        res.json({ status: 'class_details_updated_successfully', token_info: 'token_available', new_accessToken: new_access_token });
                                                                                                    }
                                                                                                } else {
                                                                                                    res.statusCode = 401;
                                                                                                    res.json({ status: 'not_allowed' });
