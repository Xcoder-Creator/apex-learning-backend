...
const list_months = require('../../utility/months_list.util'); //Import months list utility
...
const send_private_comment = async (req, res) => {
    ...
    if (environment === 'development'){
        ...
        if (req.body){
            ...
            if (form_data.access_token && form_data.class_code && form_data.classwork_id && form_data.comment && form_data.student_user_id){
                ...
                let student_user_id = sanitize_data(form_data.student_user_id);
                                                                            ...
                                                                            if (result.data.length > 0 && result.data.length === 1){
                                                                                ...
                                                                                if (resultxx.status === false){
                                                                                    ...
                                                                                    if (resultxx.data.length > 0 && resultxx.data.length === 1){
                                                                                        let resultxc = await db_query.fetch_all_records_of_joined_classes(student_user_id, class_code);
                                                                                            ...
                                                                                            if (resultxc.data.length > 0 && resultxc.data.length === 1){
                                                                                                ...
                                                                                                if (resultz.status === false){
                                                                                                    ...
                                                                                                    if (resultz.data.length === 1){
                                                                                                        ...
                                                                                                        let resultx = await db_query.create_private_comment(classwork_id, user_id, class_code, comment, formated_date, student_user_id);
                                                                                                                    ...
                                                                                                                    if (result4.status === false){
                                                                                                                        ...
                                                                                                                        if (result5.status === false){
                                                                                                                            ...
                                                                                                                            if (allow_email_notif === 'true'){
                                                                                                                                mail_service('private_comments_mail', student_email, false, false, false, null, null, null, null, class_name, null, null, null, null, class_code, null, `Your teacher just added a new private comment to the ${classwork_type} that was assigned to your class: ${class_name}`, student_name, `Your teacher just added a new private comment to the ${classwork_type} that was assigned to your class: "${class_name}"`, null, comment_data); //Send mail
        ...
        if (req.body){
            ...
            //Check if the appropriate request parameters are set
            if (form_data.class_code && form_data.classwork_id && form_data.comment && form_data.student_user_id){
                //Filter and sanitize the request parameters
                let class_code = sanitize_data(form_data.class_code);
                let classwork_id = sanitize_data(form_data.classwork_id);
                let comment = sanitize_data(form_data.comment);
