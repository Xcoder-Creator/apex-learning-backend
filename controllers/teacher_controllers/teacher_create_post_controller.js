...
const file_type_list = require('../../utility/file_type_list.util'); //Import file type list utility
const format_file_size = require('../../utility/format_file_size.util'); //Import format file size utility
                                                            ...
                                                            if (err) {
                                                                ...
                                                                if (result.status === false){
                                                                    ...
                                                                    if (result.data.length > 0 && result.data.length === 1){
                                                                        let profile_image = result.data[0].profile_image; //Profile image
                                                                        let teacher_name = result.data[0].name; //Teacher name
                                                                                                                            ...
                                                                                                                            if (result3.status === false){
                                                                                                                                ...
                                                                                                                                if (result4.status === false){
                                                                                                                                    ...
                                                                                                                                    if (result5.status === false){
                                                                                                                                        ...
                                                                                                                                        var class_name = result5.data[0].class_name;

                                                                                                                                        if (allow_email_notif === 'true'){
                                                                                                                                            mail_service('post_mail', student_email, true, false, false, student_name, null, teacher_name, profile_image, class_name, formated_date, formated_time, clean_post, post_type, class_code, null, null, null, null, null, null); //Send mail
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
                                                                                                                                            ...
                                                                                                                                            if (result3.status === false){
                                                                                                                                                ...
                                                                                                                                                if (result4.status === false){
                                                                                                                                                    ...
                                                                                                                                                    if (result5.status === false){
                                                                                                                                                        ...
                                                                                                                                                        if (allow_email_notif === 'true'){
                                                                                                                                                            mail_service('post_mail', student_email, true, false, false, student_name, teacher_name, profile_image, class_name, formated_date, formated_time, clean_post, post_type, class_code, null, null, null, null, null, null); //Send mail
                                                                                                                                                        }
                                                                                                                                                    }
                                                                                                                                                }
                                                                                                                                            }
