...
const fetch_classworks = async (req, res) => {
                                                                        ...
                                                                        if (result.status === false){
                                                                            ...
                                                                            if (result.data.length > 0 && result.data.length === 1){
                                                                                ...
                                                                                if (result.status === false){
                                                                                    ...
                                                                                    if (result.data.length > 0 && result.data.length === 1){
                                                                                        let result1 = await db_query.fetch_all_classworks(class_code);

                                                                                        if (result1.status === false){
                                                                                            res.statusCode = 500
                                                                                            res.json({ status: 'error_occured' });
                                                                                        } else if (result1.status === true){
                                                                                            let all_classworks = result1.data;
                                                                                            let available_classworks = [];

                                                                                            if (all_classworks.length > 0){
                                                                                                for await (let [i, record] of all_classworks.entries()){
                                                                                                    let result2 = await db_query.fetch_classwork_result(record.id, class_code, user_id);

                                                                                                    if (result2.status === false){
                                                                                                        res.statusCode = 500
                                                                                                        res.json({ status: 'error_occured' });
                                                                                                    } else if (result2.status === true){
                                                                                                        let result_data = result2.data;
                                                                                                        let is_done = null;

                                                                                                        if (result_data.length > 0 && result_data.length === 1){
                                                                                                            is_done = result_data[0].is_done;
                                                                                        ...
                                                                                        if (result.data.length > 0 && result.data.length === 1){
                                                                                            ...
                                                                                            if (result1.status === false){
                                                                                                ...
                                                                                                if (all_classworks.length > 0){
                                                                                                    ...
                                                                                                    res.statusCode = 200;
                                                                                                    res.json({ status: 'successfull', result: { value: false, classworks: [] }, class_code: class_code, token_info: 'no_token' });
                                                                                                }
                                                                                            }
                                                                                        } else {
                                                                                            res.statusCode = 401;
...
module.exports = fetch_classworks;