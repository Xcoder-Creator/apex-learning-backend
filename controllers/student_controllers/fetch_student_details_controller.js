...
const fetch_student_details = async (req, res) => {
                                                        ...
                                                        if (result.data.length > 0 && result.data.length === 1){
                                                            ...
                                                            if (result.status === false){
                                                                ...
                                                                if (result.data.length > 0 && result.data.length === 1){
                                                                    ...
                                                                    res.json({ status: 'details_fetched_successfully', token_info: 'token_available', new_accessToken: new_access_token, details: { student_name: user_name, student_email: user_email, student_role: role, user_id: user_id_value, student_profile_image: profile_img } });
                                                                } else {
                                                                    res.statusCode = 401;
                                                    ...
                                                    if (status === 'user_direct_access_token'){
                                                        ...
                                                        if (result.status === false){
                                                            ...
                                                            if (result.data.length > 0 && result.data.length === 1){
                                                                ...
                                                                res.statusCode = 200;
                                                                res.json({ status: 'details_fetched_successfully', token_info: 'no_token', details: { student_name: user_name, student_email: user_email, student_role: role, user_id: user_id_value, student_profile_image: profile_img } });
                                                            } else {
                                                                res.statusCode = 401;
                                                                res.json({ status: 'role_error'});
                                                            }
...
module.exports = fetch_student_details;