                                                                                ...
                                                                                if (result.data.length > 0 && result.data.length === 1){
                                                                                    ...
                                                                                    if (result.status === false){
                                                                                        ...
                                                                                        if (result.data.length > 0){
                                                                                                    ...
                                                                                                    if (all_class_posts.status === false){
                                                                                                        ...
                                                                                                        if (resultxc.status === false){
                                                                                                            ...
                                                                                                            if (resultxc.data.length >= 1){
                                                                                                                ...
                                                                                                                let classwork_id = latest_classwork.id;
                                                                                                                ...
                                                                                                                if (condition === 1){
                                                                                                                    if (moment(current_time, 'h:mm a').isBefore(moment(due_time, 'h:mm a'))){
                                                                                                                        let resultxcz = await db_query.get_student_response_to_classwork(classwork_id, user_id, class_code);

                                                                                                                        if (resultxcz.status === false){
                                                                                                                            res.statusCode = 500;
                                                                                                                            res.json({ status: 'error_occured' });
                                                                                                                        } else if (resultxcz.status === true){
                                                                                                                            if (resultxcz.data.length > 0){
                                                                                                                                res.statusCode = 200;
                                                                                            ...
                                                                                            res.statusCode = 401;
                                                                                            let new_access_token = generate_access_token(user_id, 'user_direct_access_token');
                                                                                            res.json({ status: 'not_part_of_class', token_info: 'token_available', new_accessToken: new_access_token });
                                                                                        }
                                                                                    }
                                                                                } else {
                                                                                    res.statusCode = 404;
                                                                                    ...
                                                                                    if (result.data.length > 0 && result.data.length === 1){
                                                                                        ...
                                                                                        if (result.status === false){
                                                                                            ...
                                                                                            if (result.data.length > 0){
                                                                                                ...
                                                                                                res.statusCode = 401;
                                                                                                res.json({ status: 'not_part_of_class', token_info: 'no_token' });
                                                                                            }
                                                                                        }
                                                                                    } else {
                                                                                        res.statusCode = 404;
                                                                                    ...
                                                                                    if (result.data.length > 0 && result.data.length === 1){
                                                                                        ...
                                                                                        if (result.status === false){
                                                                                            ...
                                                                                            if (result.data.length > 0){
                                                                                                ...
                                                                                                res.statusCode = 401;
                                                                                                let new_access_token = generate_access_token(user_id, 'user_direct_access_token');
                                                                                                res.json({ status: 'not_part_of_class', new_accessToken: new_access_token });
                                                                                            }
                                                                                        }
                                                                                    } else {
                                                                                        res.statusCode = 404;
