                ...
                if (/^ *$/.test(access_token)){
                    ...
                    if (/^ *$/.test(feedback)){
                        ...
                        if (feedback.length <= 500 && feedback.length !== 0){
                                                        ...
                                                        if (err) {
                                                            ...
                                                            if (result.status === false){
                                                                ...
                                                                if (result.data.length > 0 && result.data.length === 1){
                                                                    ...
                                                                    let resultx = await db_query.create_feedback(user_id, feedback, formated_date, formated_time);
                                                                    ...
                                                                    if (resultx.status === false){
                                                                        ...
                                                                        res.json({ status: 'feedback_created', token_info: 'token_available', new_accessToken: new_access_token });
                                                                    }
                                                                } else {
                                                                    //User does not exist
                                                                    res.statusCode = 404;
                                                            ...
                                                            if (status === 'user_direct_access_token'){
                                                                ...
                                                                if (result.status === false){
                                                                    ...
                                                                    if (result.data.length > 0 && result.data.length === 1){
                                                                        ...
                                                                        let resultx = await db_query.create_feedback(user_auth_id, feedback, formated_date, formated_time);
                                                                        ...
                                                                        if (resultx.status === false){
                                                                            ...
                                                                            res.statusCode = 200;
                                                                            res.json({ status: 'feedback_created', token_info: 'no_token' });
                                                                        }
                                                                    } else {
                                                                        //User does not exist
                                                                        res.statusCode = 404;
                            ...
                            res.statusCode = 401;
                            res.json({ status: 'invalid_feedback' });
                        }
                    }
                }
            } else {
