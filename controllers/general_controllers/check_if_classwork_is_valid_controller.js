...
const check_if_classwork_is_valid = async (req, res) => {
                                                                                                ...
                                                                                                if (result3.data.length > 0 && result3.data.length === 1){
                                                                                                    ...
                                                                                                    if (resultx.status === false){
                                                                                                        ...
                                                                                                        if (resultx.data.length > 0 && resultx.data.length === 1){
                                                                                                            ...
                                                                                                            res.json({ status: 'work_submitted', msg: 'work_has_been_submitted_already', token_info: 'token_available', new_accessToken: new_access_token });
                                                                                                        } else {
                                                                                                            ...
                                                                                                            if (condition === 1){
                                                                                                                if (moment(current_time, 'h:mm a').isBefore(moment(classwork_due_time, 'h:mm a'))){
                                                                                                                    res.statusCode = 200;
                                                                                                                    let new_access_token = generate_access_token(user_id, 'user_direct_access_token');
                                                                                                                    res.json({ status: true, msg: 'classwork_valid', token_info: 'token_available', new_accessToken: new_access_token });
                                                                                                                } else {
                                                                                                                    res.statusCode = 200;
                                                                                                                    
                                                                                                                    let new_access_token = generate_access_token(user_id, 'user_direct_access_token');
                                                                                                                    res.json({ status: false, msg: 'classwork_expired', token_info: 'token_available', new_accessToken: new_access_token });
                                                                                                                }
                                                                                                            } else if (condition === 2){
                                                                                                                res.statusCode = 200;
                                                                                                                let new_access_token = generate_access_token(user_id, 'user_direct_access_token');
                                                                                                ...
                                                                                                if (result3.status === false){
                                                                                                    ...
                                                                                                    if (result3.data.length > 0 && result3.data.length === 1){
                                                                                                        ...
                                                                                                        if (resultx.status === false){
                                                                                                            ...
                                                                                                            if (resultx.data.length > 0 && resultx.data.length === 1){
                                                                                                                res.statusCode = 200;
                                                                                                                res.json({ status: 'work_submitted', msg: 'work_has_been_submitted_already', token_info: 'no_token' });
                                                                                                            } else {
                                                                                                                let current_date = moment().format("YYYY-MM-DD");
                                                                                                                let current_time = moment().format('h:mm a');
                                                                                                                ...
                                                                                                                if (condition === 1){
                                                                                                                    if (moment(current_time, 'h:mm a').isBefore(moment(classwork_due_time, 'h:mm a'))){
                                                                                                                        res.statusCode = 200;
                                                                                                                        res.json({ status: true, msg: 'classwork_valid', token_info: 'no_token' });
                                                                                                                    } else {
                                                                                                                        res.statusCode = 200;
                                                                                                                        
                                                                                                                        res.json({ status: false, msg: 'classwork_expired', token_info: 'no_token' });
                                                                                                                    }
                                                                                                                } else if (condition === 2){
                                                                                                                    res.statusCode = 200;
                                                                                                                    res.json({ status: true, msg: 'classwork_valid', token_info: 'no_token' });
...
module.exports = check_if_classwork_is_valid;